...
public class CustomDialog_DueDate extends Dialog implements View.OnClickListener{

    private static final int LAYOUT = R.layout.activity_custom_dialog_duedate;
    ...
    public CustomDialog_DueDate(@NonNull Context context) {
        super(context);
        this.context = context;
    }

    public CustomDialog_DueDate(Context context, String name){
        super(context);
        this.context = context;
        this.name = name;
    }
