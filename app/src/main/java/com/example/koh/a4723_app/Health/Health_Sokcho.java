...
public class Health_Sokcho extends AppCompatActivity {
    ...
    private String[] items = {"임신,출산 지원 사업", "보건 사업" };
       ...
       _listview.setOnItemClickListener(onItemClickListener);
        ...
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Health_Sokcho.this);
                LayoutInflater inflater = getLayoutInflater();
                ImageView dialoglayout = (ImageView) inflater.inflate(R.layout.dialog_layout, null);
                dialoglayout.setImageResource(R.drawable.map_sokcho);
        ...
        phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Permission== PackageManager.PERMISSION_GRANTED){
                    Intent callIntent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:033-639-2915"));
